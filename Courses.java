...
public class Courses {
	public static boolean registercourses(String username,String courseid,String coursename) throws SQLException {
	...
	public static void getCourses(String username) throws SQLException {
		Connection connection = new ConnectionEstablishment().createConnection();
	...
	public  static boolean createNewCourses(String courseid, String coursename) throws ClassNotFoundException, SQLException
	{
		Connection connection = new ConnectionEstablishment().createConnection();
		try {
			try {
	...
	public static void main(String []args) throws ClassNotFoundException, SQLException {
		boolean isadded=createNewCourses("12345","P.E.T");
